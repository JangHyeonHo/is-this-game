...
/// </para>
/// 근거: docs/07-decisions.md §17.8, §17.9, §17.10
/// </summary>
public static class ContractBoard
{
    ...
    /// </para>
    /// <para>
    /// 근본 원인은 <c>docs/08</c> #33이 이미 경고한 것입니다 — <b>수로 난이도를 나타내면
    /// 난이도가 두 번 반영됩니다.</b> 난이도는 적을 <b>강하게</b> 만들고, 수는 파티 인원이 정합니다.
    /// </para>
    /// <para>
    /// 측정(docs/08 #42): 월당 처치는 2인 1.69 · 3인 2.54 · 4인 3.39이고
    ...
    /// 최소 인원(2명)의 월당 처치 평균 <b>1.69</b>에서 여유를 둔 값입니다 (docs/08 #42).
    /// <para>
