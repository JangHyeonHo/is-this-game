...
public static class Jobs
{
    ...
    private static IEnumerable<Job> Ladder(
        WeaponKind weapon, JobId[] ids, string[] names, params SkillId[] grants)
    {
    ...
    [
        ...
        .. Ladder(WeaponKind.Shield,
            ...
            SkillId.Shielding, SkillId.Provoke),
        ...
        .. Ladder(WeaponKind.Greatsword,
            ...
            SkillId.HeavyBlow, SkillId.Sweep),
        ...
        .. Ladder(WeaponKind.Staff,
            ...
            SkillId.Cure, SkillId.Empower, SkillId.Enfeeble),
        ...
        new(JobId.Quartermaster, "수송대장",
            ...
            [SkillId.HandPotion, SkillId.Packcraft, SkillId.Cheerful],
            ActiveSlots: 4, MaxContractDifficulty: 8, Upkeep: 520, Combat: false),

        // ---- 히든 — 숙련 조합으로만 열립니다 ----
        // 평균이 아니라 합집합입니다: 양쪽 직업이 각각 가진 장점을 흡수합니다.
        // 대가는 규칙이 아니라 시간입니다 — 두 숙련을 올리는 데 배로 걸리고,
        // 그동안 그 캐릭터는 오래 어중간하며, 경력이 유한하므로 못 닿을 수도 있습니다.
        new(JobId.SpellArcher, "마궁사",
            new Dictionary<WeaponKind, int> { [WeaponKind.Bow] = 60, [WeaponKind.Staff] = 60 },
            [SkillId.SteadyAim, SkillId.Cure, SkillId.Empower],
            ActiveSlots: 5, ProficiencyBonus: 0.20,
            MaxContractDifficulty: 8, Upkeep: 760),

        new(JobId.SpellBlade, "마검사",
            new Dictionary<WeaponKind, int> { [WeaponKind.Sword] = 60, [WeaponKind.Staff] = 60 },
            [SkillId.TwinStrike, SkillId.Empower, SkillId.Enfeeble],
            ActiveSlots: 5, ProficiencyBonus: 0.20,
            MaxContractDifficulty: 8, Upkeep: 760)
    ];
